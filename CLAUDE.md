...
- **مفيش حارس توافق في الواجهة خالص** — لا `MIN_WORKER_VERSION` ولا أي مقارنة
  بين نسخة الـ Worker ونسخة الـ HTML (اتفحص 03-09-2026). يعني لو الاتنين
  اتفرّقوا في عقد الرد، الأداة هتفشل من غير أي تحذير. الإضافة مؤجَّلة لأول
  مرة الواجهة تتفتح لسبب حقيقي — والصيغة الصح حد أدنى رقمي مش تطابق حرفي
