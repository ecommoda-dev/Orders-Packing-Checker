...
**الإصدار:** Worker `v2.2.0` · الواجهة `v2.2.0` · `MIN_WORKER_VERSION = 2.2.0`   ← الاتنين مستقلين، طبيعي يختلفوا
...
3. **بعد أي تغليف ناجح أو جزئي** — `rdyLoadOrders({ silent: true })`.
   الأوردر اتكتب عليه فعلاً في الحالتين، يعني المفروض يخرج من الطابور.
   **قايمة كاذبة أسوأ من قايمة قديمة.**
...
آخر مطابقة: 05-09-2026 · `index.js` v2.2.0 · `index.html` v2.2.0
